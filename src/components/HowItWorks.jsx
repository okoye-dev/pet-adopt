...
const HowItWorks = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-6 bg-slate-100 px-10 py-10 md:px-16 lg:gap-10 lg:px-20">
      ...
      <section className="flex flex-wrap items-center justify-around gap-6 py-5 text-xs">
        {steps.map((instance, id) => (
          ...
          >
            <span
              className={`flex h-10 w-10 flex-col items-center justify-center rounded-xl shadow-xl ${id === 0 ? "bg-purple-500 shadow-purple-500/30" : id === 1 ? "bg-cyan-300 shadow-cyan-500/30" : "bg-pink-300 shadow-pink-500/30"}`}
            >
              <img
                src={instance.img}
                alt={"search"}
